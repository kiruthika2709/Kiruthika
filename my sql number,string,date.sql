...
select date_format(curdate(),"%d\%m\%y");
select datediff(curdate(),'2027-1-1');
select datediff("2027-1-1",curdate());
select date_add(curdate(),interval 2 day);
select date_add(curdate(),interval 2 day) as yesterday;
select date_add(curdate(),interval -1 month);
select date_add(curdate(),interval 2 month) as month; 
select date_add(curdate(),interval 2 year) as year;
select date_add(curdate(), interval -2 year) as year;
